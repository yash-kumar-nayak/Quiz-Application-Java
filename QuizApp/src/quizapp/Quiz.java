...
public class Quiz extends JFrame implements ActionListener {
    ...
    Quiz(String name){
        ...
        add(qno);
         question=new JLabel("");
        question.setBounds(150, 430, 900, 30);
      ...
      opt2=new JRadioButton("");
        ...
        next.setBounds(1110, 550, 140, 35);
        ...
        lifeline.setBounds(1110, 600, 140, 35);
        lifeline.setBackground(new Color(30,144,255));
        lifeline.setFont(new Font("Times New Roman",Font.PLAIN,17));
         lifeline.setForeground(Color.WHITE);
         lifeline.addActionListener(this);
        add(lifeline);
         submit=new JButton("SUBMIT");
        submit.setBounds(1110, 650, 140, 35);
